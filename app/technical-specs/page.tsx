...
export default function TechnicalSpecsPage() {
  const solidSheetSpecs = [
    {
      property: "Material",
      value: "100% Virgin Polycarbonate (SABIC/Covestro)",
    },
    ...
    {
      property: "UV Protection",
      value: "Co-extruded (one or both sides customizable)",
    },
  ...
  const multiwallSheetSpecs = [
    ...
    {
      property: "Light Transmission (Clear)",
      value: "Up to 82% (varies by thickness)",
    },
  ...
  const profileSheetSpecs = [
    { property: "Material", value: "Polycarbonate" },
    {
      ...
      value: "Corrugated, Greca, etc. (matching roofing designs)",
    },
    ...
    {
      property: "Colors",
      value: "Clear, Opal, Bronze, Blue, Green, Smoke Grey",
    },
  ];
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center animate-slide-up">
            ...
            <p className="text-xl md:text-2xl mb-8">
              Comprehensive technical data and standards for all SGLite®
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Detailed physical properties and performance characteristics for
              our Compact, Embossed, and Diamond textured solid sheets.
            </p>
          </div>
      ...
      <section className="py-16 lg:py-24 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Comprehensive data on thermal insulation, light transmission, and
              structural properties for our multiwall sheets.
            </p>
          </div>
          <Card className="max-w-6xl mx-auto shadow-lg hover:shadow-xl transition-shadow duration-300">
            <CardContent className="p-6">
      ...
      <section className="py-16 lg:py-24">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Technical details for our profile sheets, designed for secure
              overlaps and enhanced structural strength.
            </p>
          </div>
          <Card className="max-w-6xl mx-auto shadow-lg hover:shadow-xl transition-shadow duration-300">
            <CardContent className="p-6">
      ...
      <section className="py-16 lg:py-24 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Specifications for our strong, weather-resistant connectors,
              ensuring seamless and durable installations.
            </p>
          </div>
          <Card className="max-w-6xl mx-auto shadow-lg hover:shadow-xl transition-shadow duration-300">
            <CardContent className="p-6">
