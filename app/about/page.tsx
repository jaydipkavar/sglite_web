...
export default function AboutPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section id="infrastructure" className="py-16 lg:py-24 bg-gray-100 animate-fade-in-up">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 animate-slide-up">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-6">Our Infrastructure</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our state-of-the-art manufacturing facility ensures precision, quality, and efficiency in every sheet we
              produce.
            </p>
          </div>
