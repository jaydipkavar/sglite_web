      ...
      <section className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-20 animate-fade-in">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center animate-slide-up">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Compact (Glossy) Polycarbonate Sheet</h1>
            <p className="text-xl md:text-2xl mb-8">
              High-gloss finish with exceptional optical clarity and maximum light transmission for premium
              applications.
            </p>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              SGLite Compact Polycarbonate Sheets are versatile and suitable for a wide array of projects requiring high
      ...
      <section className="py-16 lg:py-24">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Detailed specifications for SGLite Compact (Glossy) Polycarbonate Sheets.
            </p>
          </div>
