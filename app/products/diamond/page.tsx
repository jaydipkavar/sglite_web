        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center animate-slide-up">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Diamond (Criss-Cross Textured) Polycarbonate Sheet
            </h1>
            <p className="text-xl md:text-2xl mb-8">
              Unique diamond pattern for decorative applications with anti-slip
              properties and enhanced light diffusion.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              SGLite Diamond Textured Polycarbonate Sheets are perfect for
              projects requiring both aesthetic appeal and functional properties
              like anti-slip surfaces.
            </p>
          </div>
      ...
      <section className="py-16 lg:py-24">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Detailed specifications for SGLite Diamond (Criss-Cross Textured)
