...
export default function PCHollowTypeSPage() {
  ...
  const technicalSpecs = [
    ...
    {
      property: "Structure",
      value: "Specialized Multiwall (e.g., X-structure, Honeycomb)",
    },
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center animate-slide-up">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              PC Hollow Polycarbonate Sheet - Type S
            </h1>
            <p className="text-xl md:text-2xl mb-8">
              Specialized multi-wall design for enhanced structural integrity,
              superior thermal insulation, and unique light diffusion.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              SGLite PC Hollow Type S sheets are engineered for high-performance
              applications where advanced thermal efficiency and structural
