  ...
  const multiwallTypes = [
    {
      thickness: "4mm",
      description:
        "Lightweight and flexible, ideal for basic roofing and DIY projects.",
      features: [
    ...
    },
    {
      thickness: "6mm",
      description:
        "A versatile option offering a balance of strength, insulation, and light transmission.",
      features: [
    ...
    },
    {
      thickness: "8mm",
      description:
        "Enhanced insulation and rigidity for more demanding applications.",
      features: [
    ...
    },
    {
      thickness: "10mm",
      description:
        "Robust and highly insulating, perfect for energy-efficient structures.",
      features: [
    ...
    },
    {
      thickness: "12mm",
      description:
        "Our thickest multiwall sheet, providing ultimate strength and thermal performance.",
      features: [
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center animate-slide-up">
            ...
            <p className="text-xl md:text-2xl mb-8">
              Lightweight, UV-protected, and energy-efficient solutions for
              diverse roofing and glazing needs.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              SGLite offers multiwall polycarbonate sheets in various
              thicknesses, each designed to provide optimal thermal insulation,
              light transmission, and structural integrity for specific
              applications.
            </p>
          </div>
