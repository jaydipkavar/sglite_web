...
>(({ className, ...props }, ref) => (
  <div className="absolute left-0 top-full flex justify-center z-50">
    <NavigationMenuPrimitive.Viewport
      ref={ref}
      className={cn(
        "relative mt-1.5 origin-top-center " +
          "h-[var(--radix-navigation-menu-viewport-height)] " +
          "md:w-[var(--radix-navigation-menu-viewport-width)] " + // ✅ content-based width (not full)
          "overflow-visible rounded-md border bg-white text-gray-900 " +
          "shadow-lg p-4 leading-relaxed text-base " +
