...
export default function HeroSlider() {
  const slides = [
    {
      id: 1,
      image: "/public/images/slider/slide1.jpg",
    ...
    },
    {
      ...
      subtitle:
        "Discover how SGLite® sheets enhance durability and aesthetics in diverse applications.",
    ...
    },
    {
      ...
      subtitle:
        "Our sheets offer unmatched thermal insulation, impact resistance, and UV protection.",
    ...
    <section className="relative h-[600px] md:h-[700px] lg:h-[800px] flex items-center justify-center text-center text-white overflow-hidden">
      ...
      <div className="relative z-20 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="animate-fade-in-up">
          <Badge className="mb-6 bg-white bg-opacity-20 text-black border-white/30 text-lg px-6 py-2">
            {slide.badge}
          </Badge>
